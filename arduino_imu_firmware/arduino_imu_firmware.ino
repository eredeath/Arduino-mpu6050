...
#define FREQ  10.0 // sample freq in Hz
...
void read_sensor_data() {
  ...
  temp = ((i2cData[6] << 8) | i2cData[7]) / 340 + 36.53;
...
void create_arrows() {
  ...
  lcd.createChar(upArrow, arrowA1);
  lcd.createChar(downArrow, arrowA4);
  lcd.createChar(leftArrow, arrowA2);
  lcd.createChar(rightArrow, arrowA3);
}
